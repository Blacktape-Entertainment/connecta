  ...
  return (
    <div className="flex flex-col gap-2 group">
      ...
      <input
        ...
        } rounded-lg px-3 py-2 text-light font-body text-sm outline-none transition-all duration-300 placeholder:text-light/50 focus:border-gradient1 focus:bg-light/15 focus:ring-1 focus:ring-gradient1/30 hover:border-gradient1/60 hover:bg-light/12`}
      />
      {error && (
